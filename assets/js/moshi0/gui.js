cc.Class({
    ...
    shasi() {
        ...
        this.tx.getChildByName("tx0").active=true;
        ...
        this.node.getComponent(sp.Skeleton).setCompleteListener((a, evt) => {
            switch (a.animation.name) {
                case "attack":
                    ...
                    this.tx.getChildByName("tx0").active=false;
                    ...
                    if(SHUJU.duoshu[this.po]==1){
                        if (SHUJU.xuannpc == this.wan) {
                            ...
                            if (SHUJU.yao[8] > 0) {
                                this.cus2 = cc.instantiate(this.diaoyao);
                                this.cus2.parent = this.node.parent;
                                this.cus2.setPosition(this.wan.x, -300);
                                this.cus2.getComponent("diaoyao").chu(SHUJU.yao[8],0,true)
                                SHUJU.yao[8] = 0
                                this.node.parent.getChildByName("bg").getComponent("bg1").suanyao();
                            ...
                            if (SHUJU.yao[siid] > 0) {
                                this.cus2 = cc.instantiate(this.diaoyao);
                                this.cus2.parent = this.node.parent;
                                this.cus2.setPosition(SHUJU.xuannpc.x, -300);
                                this.cus2.getComponent("diaoyao").chu(SHUJU.yao[siid],siid,true)
                                SHUJU.yao[siid] = 0
                                SHUJU.xuannpc.getComponent("npcren").suanyao();
                ...
                case "attack":
                    ...
                    if (this.sha[0] == this.wan) {
                        ...
                        if (SHUJU.yao[siid] > 0) {
                            this.cus2 = cc.instantiate(this.diaoyao);
                            this.cus2.parent = this.node.parent;
                            this.cus2.setPosition(this.sha[0].x, -300);
                            this.cus2.getComponent("diaoyao").chu(SHUJU.yao[siid],siid,true)
                            SHUJU.yao[siid] = 0
                            this.sha[0].getComponent("npcren").suanyao();
